...
from src.nlp.reversible_dilated_bert.blocks import AttentionBlock, ReversibleFullAttentionBlock, activation_mapper
...
class DocumentElectraPretrainingModel(DocumentElectraPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        with open (pretrained_model_name_or_path + "/config.json", "r") as f:
            config_dict = json.load(f)
            config = DocumentElectraConfig(**config_dict)
