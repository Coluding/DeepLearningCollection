...
class MultiheadDilatedAttention(nn.Module):
    ...
    def _reset_parameters(self):
        ...
        Additionally, for the value and output projections, a reversible_dilated_bert gain factor is applied
        during initialization, following strategies outlined in the MAGNETO paper. This
        reversible_dilated_bert gain is crucial for adapting the initialization process to the specific
        ...
        - Xavier normal initialization for weights of query, key, value, and output
          projections. The value and output projections use a reversible_dilated_bert gain (`self.gamma_init`).
        ...
        thereby aiding in the efficient training of the network. The reversible_dilated_bert gain factor
...
class MultiHeadLocalAttention(nn.Module):
    ...
    def forward(self, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor):
        ...
        # Apply reversible_dilated_bert attention
